...
import com.tours.Exception.InvalidTourDataException;
import com.tours.Logging.TourLogger;
import com.tours.Repo.ToursRepo;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Service;
...
public class ToursService {
    ...
    // Create a new Tour
    public Tours createTour(Tours tour) {
        if (tour.getTourName() == null || tour.getStartDate() == null) {
            throw new InvalidTourDataException("All tour details is needed.");
        }
        TourLogger.info("Creating a new tour: " + tour.getTourName());
        return tourRepository.save(tour);
    }
