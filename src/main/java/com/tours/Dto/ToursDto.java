...
public class ToursDto {
    ...
    // Updated fields for associated entities to be lists
    private List<LocationDto> locations; // Changed to List
    private List<LodgingDto> lodgings;   // Changed to List
    private List<TransportDto> transports; // Changed to List

    public ToursDto(Long id, String tourName, String tourDescription, String tourGuide, LocalDate startDate, LocalDate endDate, List<String> meals, List<String> activities, double price, int ticketsAvailable, List<String> tourImages, List<LocationDto> locations, List<LodgingDto> lodgings, List<TransportDto> transports) {
        this.id = id;
        this.tourName = tourName;
        this.tourDescription = tourDescription;
        this.tourGuide = tourGuide;
